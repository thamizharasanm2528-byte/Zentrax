const fs = require('fs');
const files = [
    'd:/LLK/zentrax-client/src/components/AIChat.jsx',
    'd:/LLK/zentrax-client/src/pages/AI/AIAssistant.jsx',
    'd:/LLK/zentrax-client/src/components/ChatSidebar.jsx',
    'd:/LLK/zentrax-client/src/pages/Messages/DirectMessages.jsx'
];
